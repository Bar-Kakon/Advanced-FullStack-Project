...
export const en: Strings = {
  ...
  editProfile: {
    ...
    equipment: {
      notStored: 'The heavy-equipment list is not stored on the server yet — it has no data model — so a choice here will not be kept.',
    ...
    work: {
      ...
      imageLabel: 'Photo',
      addFailed: 'The entry could not be added. Please try again.',
      removeFailed: 'The entry could not be removed. Please try again.',
    },
