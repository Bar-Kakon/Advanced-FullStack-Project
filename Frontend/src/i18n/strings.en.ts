...
export const en: Strings = {
  ...
  browse: {
    ...
    filters: {
      ...
      availability: { label: 'Availability', placeholder: 'Any availability' },
    ...
    card: {
      ...
      connecting: 'Sending…',
      message: 'Message',
      messagingSoon: 'Messaging has not been built yet.',
      connected: 'Connected',
    ...
    profile: {
      ...
      phonesHidden: 'Contact details are not shown. They appear only on a shared project or against an existing work commitment.',
    ...
    travel: {
      title: 'Places you are willing to travel to',
      radiusLabel: 'Preferred travel distance',
      baseLabel: 'Your base location',
      propose: 'Find locations',
      proposing: 'Calculating…',
      reviewQuestion: 'These are the places you have confirmed you are willing to reach. Are there any you would like to remove?',
      ...
      remove: 'Remove',
      removedTitle: 'Places you removed',
      removedNote: 'These will not be suggested to you again. To approve one, add it manually in the field below.',
