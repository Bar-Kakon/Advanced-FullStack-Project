...
export const he = {
  ...
  browse: {
    ...
    advanced: {
      ...
      ratingLede: 'הצגת קבלנים שהדירוג הממוצע שקיבלו הוא לפחות כמספר הכוכבים שתבחרו.',
      ratingHint: 'לחצו על מספר הכוכבים המינימלי. קבלנים שטרם קיבלו דירוג אינם עומדים בסינון הזה.',
    ...
    travel: {
      ...
      remove: 'הסרה',
      removedTitle: 'מקומות שהסרתם',
      removedNote: 'מקומות אלו לא יוצעו לכם שוב. כדי לאשר מקום מחדש, הוסיפו אותו ידנית בשדה שלמטה.',
