...
export const he = {
  ...
  notifications: {
    ...
    emptyUnread: 'הכול נקרא.',
    unreadOnly: 'רק שלא נקראו',
    all: 'הכול',
    markAllSeen: 'סימון הכול כנקרא',
    markSeen: 'סימון כנקרא',
    loadMore: 'טעינת עוד',
    loading: 'טוען התראות…',
    unreadBadge: 'התראות שלא נקראו',
    blocking: 'ממתין לתשובה',
    nonblocking: 'לידיעה',
    mutedNote: 'הפרויקט מושתק — ההתראה נרשמה ולא נשלחה בדוא״ל.',
    open: 'פתיחה',
    errors: {
      load: 'לא הצלחנו לטעון את ההתראות.',
      network: 'לא הצלחנו להגיע לשרת. כדאי לבדוק את החיבור ולנסות שוב.',
    },
    types: {
    ...
    language: {
      title: 'שפת הממשק',
      note: 'השפה נשמרת בחשבון, וגם הודעות הדוא״ל נכתבות בה.',
      hebrew: 'עברית',
      english: 'אנגלית',
      save: 'שמירת שפה',
    },
    notifications: {
      title: 'התראות',
      inAppNote: 'התראות שממתינות לתשובה מופיעות במערכת מיד, בכל תוכנית.',
      operationalEmail: 'קבלת הודעות תפעוליות בדוא״ל',
      operationalEmailNote: 'אופציונלי לחלוטין. בלעדיו המערכת פועלת במלואה, וההתראות ממשיכות להופיע בפנים.',
      notMarketing: 'זו אינה הרשמה לדיוור שיווקי.',
      graceNote: 'הודעה בדוא״ל נשלחת רק אם ההתראה לא נצפתה במערכת בתוך 90 דקות.',
      digest: 'סיכום יומי',
      digestOnBasic: 'הסיכום היומי כלול מתוכנית בסיסית ומעלה.',
      digestNotIncluded: 'הסיכום היומי אינו כלול בתוכנית הנוכחית.',
      timingTitle: 'שעות שקטות',
      timingNote: 'שליטה בשעות מגיעה עם תוכנית פרימיום, ומזיזה רק מתי נשלח דוא״ל — לא אם ההתראה מופיעה.',
      timingNotIncluded: 'שליטה בשעות אינה כלולה בתוכנית הנוכחית.',
      quietFrom: 'שקט מ',
      quietTo: 'שקט עד',
      digestHour: 'שעת הסיכום היומי',
      save: 'שמירת העדפות התראה',
    },
    contact: {
      title: 'פרטי קשר בפרופיל',
      note: 'טלפון אישי לא מוצג בשום מקום, ואינו נשמר במערכת.',
      automaticNote: 'ניהול משותף בפרויקט ושני הצדדים למשימה רואים את המספר בכל מקרה. ההגדרות כאן חלות על כל השאר.',
      connectionNote: 'קשר ברשת אינו חושף מספר טלפון.',
      email: 'הצגת כתובת הדוא״ל',
      businessPhone: 'הצגת הטלפון העסקי',
      officePhone: 'הצגת טלפון המשרד',
      save: 'שמירת נראות',
    },
    mutes: {
      title: 'פרויקטים מושתקים',
      note: 'השתקה מפחיתה משלוח בדוא״ל בלבד. היא אינה משנה הרשאות, גישה או מה שקורה בפרויקט.',
      empty: 'אין פרויקטים מושתקים.',
      unmute: 'ביטול השתקה',
    },
    plan: {
      title: 'תוכנית ומנוי',
      note: 'ניהול התוכנית והתשלום נמצא במסך התוכניות.',
      link: 'מעבר לתוכניות',
      current: 'התוכנית הנוכחית',
      codes: { free: 'חינם', basic: 'בסיסית', premium: 'פרימיום' },
    },
    account: {
      title: 'החשבון',
      deactivationTitle: 'סגירת חשבון',
      deactivationNote: 'בקשת מחיקה היא השבתה עם תקופת שחזור של 60 יום, והיסטוריית העבודה המשותפת נשמרת.',
      deactivationPending: 'הפעולה אינה זמינה עדיין: הטיפול בהתחייבויות פעילות טרם נסגר.',
    },
    errors: {
      load: 'לא הצלחנו לטעון את ההגדרות.',
      save: 'לא הצלחנו לשמור את השינוי.',
      network: 'לא הצלחנו להגיע לשרת. כדאי לבדוק את החיבור ולנסות שוב.',
    },
  },  scheduleExceptions: {
    ...
    loading: 'טוען חריגים…',
    empty: 'אין בקשות חריג בפרויקט הזה.',
    newTitle: 'בקשת חריג',
    forSelfNote: 'הבקשה מוגשת עבורך בלבד.',
    kind: 'סוג',
    kinds: { non_working: 'יום שלא ייעבד', working: 'יום עבודה חריג' },
    scope: 'היקף',
    scopes: { project: 'כל הפרויקט', task: 'משימה אחת', professional: 'העבודה שלי' },
    task: 'משימה',
    fromDate: 'מתאריך',
    toDate: 'עד תאריך',
    reason: 'סיבה',
    reasonPlaceholder: 'למשל: מילואים, השלמת יציקה',
    submit: 'שליחת בקשה',
    status: 'סטטוס',
    statuses: {
    ...
    decidedBy: 'הוכרע על ידי',
    approve: 'אישור',
    reject: 'דחייה',
    modify: 'שינוי הבקשה',
    modifyNote: 'שינוי חוזר אל מגיש הבקשה לאישורו, ואינו מאשר את הבקשה.',
    cancel: 'משיכת הבקשה',
    decisionNote: 'הערת החלטה',
    finalNote: 'אישור של בעל סמכות מסיים את העניין. אין אישור שני.',
    historyTitle: 'היסטוריית הבקשה',
    actions: {
      requested: 'הוגשה',
      modified: 'שונתה',
      approved: 'אושרה',
    ...
    calendarTitle: 'ימים שנקבעו אחרת',
    calendarEmpty: 'אין תאריכים מאושרים ששונים מהשבוע הרגיל.',
    dayWorking: 'יום עבודה',
    dayNonWorking: 'לא ייעבד',
    errors: {
      load: 'לא הצלחנו לטעון את החריגים.',
      submit: 'לא הצלחנו לשלוח את הבקשה.',
      window: 'תאריך הסיום מוקדם מתאריך ההתחלה.',
      tooLong: 'בקשה אחת אינה יכולה לכסות יותר משנה.',
      notPermitted: 'אין הרשאה לפעולה הזו.',
      decided: 'הבקשה כבר הוכרעה.',
      projectScope: 'חריג לכל הפרויקט אינו בקשה עבור עצמך, ולכן נדרשת הרשאת אישור.',
      network: 'לא הצלחנו להגיע לשרת. כדאי לבדוק את החיבור ולנסות שוב.',
    },
  },  editTask: {
    title: 'עריכת משימה',
    lede: 'שינוי פרטי העבודה. מועדים מתואמים בנפרד.',
    loading: 'טוען…',
    taskTitle: 'שם המשימה',
    description: 'תיאור',
    stage: 'שלב',
    ownCrewOnly: 'העבודה לא תימסר לגורם אחר',
    delegatorOnSiteRequired: 'נוכחות באתר נדרשת גם לאחר מסירה',
    ...
    saved: 'השינויים נשמרו',
    datesTitle: 'מועדים',
    datesThroughProposal: 'שינוי מועד בעבודת פרויקט עובר דרך תיאום המועדים, כדי שכל מי שמושפע יידע ויאשר.',
    goToDateChange: 'פתיחת בקשת שינוי מועד',
    datesDirectNote: 'העבודה הזו עצמאית ואינה משפיעה על אף אחד אחר, ולכן המועדים נערכים כאן.',
    notPermitted: 'אין הרשאה לערוך את העבודה הזו.',
    responsibilityNote: 'העברת אחריות מתבצעת במסך המשימה, לא כאן.',
    errors: {
      save: 'לא הצלחנו לשמור את השינויים.',
      datesNeedProposal: 'מועד בעבודת פרויקט משתנה דרך תיאום המועדים.',
      empty: 'לא שונה דבר.',
      dueBeforeStart: 'תאריך היעד מוקדם מתאריך ההתחלה.',
      network: 'לא הצלחנו להגיע לשרת. כדאי לבדוק את החיבור ולנסות שוב.',
    },
  },
  messaging: {
    documentTitle: 'הודעות — Blokta',
    title: 'הודעות',
    lede: 'שיחות אישיות וחדרי פרויקט.',
    inbox: 'תיבת הדואר',
    requests: 'בקשות',
    loading: 'טעינת השיחות…',
    failure: 'לא ניתן לטעון את השיחות.',
    emptyInbox: 'אין שיחות עדיין.',
    emptyRequests: 'אין בקשות שממתינות לתשובה.',
    pickConversation: 'בחירת שיחה מהרשימה.',
    projectRoom: 'חדר פרויקט',
    pendingRequest: 'בקשה שממתינה לתשובה',
    accept: 'אישור',
    decline: 'דחייה',
    loadOlder: 'טעינת הודעות קודמות',
    ...
    agreementStates: {
      proposed: 'ממתין לתשובה',
      accepted: 'אושר, ונפתחה משימה',
      declined: 'נדחה',
      withdrawn: 'בוטל',
    },
  },
