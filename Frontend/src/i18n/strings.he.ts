...
export const he = {
  ...
  brand: {
    ...
    footerNote:
      'אותו קבלן יכול להיות קבלן ביצוע ראשי בפרויקט אחד וקבלן משנה באחר. התפקיד עוקב אחר העבודה, לא אחרי האדם.',
  },
  ...
  tasks: {
    ...
    row: {
      ...
      pendingProposal: 'ממתין לתגובה שלי על שינוי תאריך',
    ...
    detail: {
      ...
      dateChange: {
        ...
        lede: 'הבקשה אינה משנה את הלוח בעצמה. היא מוצגת לגורם שמוסמך להכריע בפרויקט, יחד עם ההשפעה שלה.',
        daysLabel: 'תוספת ימי עבודה',
        altStartLabel: 'תאריך התחלה חלופי',
        reasonLabel: 'הסיבה לבקשה',
        preview: 'חישוב ההשפעה',
        submit: 'שליחת הבקשה',
        affected: 'עבודות מושפעות: {n}',
        others: 'בעלי מקצוע נוספים שיישאלו: {n}',
        unaffected: 'עבודות שממשיכות כרגיל: {n}',
        beyondCeiling: 'הבקשה חורגת מתקרת האיחור של הפרויקט, ולכן לא ניתן להגיש אותה כפי שהיא.',
        sent: 'הבקשה נשלחה וממתינה להחלטת הגורם המוסמך.',
        failed: 'לא ניתן לשלוח את הבקשה כרגע.',
        emptyChange: 'צריך לבקש לפחות שינוי אחד — תוספת ימים או תאריך חלופי.',
        openRequest: 'מעבר לבקשה',
        request: 'בקשה לשינוי תאריך',
        impact: 'שינוי כאן נוגע גם ב־{n} עבודות נוספות.',
        impactNone: 'שינוי כאן אינו נוגע בעבודה אחרת.',
      },
  ...
  landing: {
      ...
      cards: [
        {
          ...
          body: 'אותו קבלן יכול להיות קבלן ביצוע ראשי בפרויקט אחד וקבלן משנה באחר. התפקיד עוקב אחר העבודה, לא אחרי האדם — והפלטפורמה מתווכת בין הצדדים במקום לשרת צד אחד.',
        },
        {
    ...
    contact: {
      title: 'יצירת קשר',
      lede: 'שאלה, בקשה או פנייה אחרת — הטופס נשלח לצוות הפלטפורמה.',
      name: { label: 'שם מלא', placeholder: 'שם פרטי ומשפחה' },
      email: { label: 'דואר אלקטרוני', placeholder: 'name@example.com', error: 'כתובת הדואר האלקטרוני אינה תקינה' },
      topic: {
        label: 'נושא הפנייה',
        placeholder: 'בחירת נושא',
        general: 'שאלה כללית',
        support: 'תמיכה טכנית',
        partnership: 'שיתוף פעולה עסקי',
        other: 'אחר',
      },
      message: {
        label: 'תוכן הפנייה',
        placeholder: 'פירוט הפנייה',
        hint: 'לפחות 10 תווים, עד 2000.',
        error: 'תוכן הפנייה קצר מדי',
      },
      submit: 'שליחת פנייה',
      submittedTitle: 'הפנייה נשלחה',
      submitted: 'הפנייה התקבלה ונשמרה. מענה יישלח לכתובת הדואר האלקטרוני שהוזנה.',
      again: 'שליחת פנייה נוספת',
      errors: {
        validation: 'חלק מהפרטים אינם תקינים. כדאי לבדוק את השדות ולנסות שוב.',
        rateLimited: 'נשלחו יותר מדי פניות מהמכשיר הזה. אפשר לנסות שוב בעוד שעה.',
        network: 'אין חיבור לשרת. כדאי לבדוק את החיבור לאינטרנט ולנסות שוב.',
        unknown: 'שליחת הפנייה נכשלה. אפשר לנסות שוב.',
      },
    },
  ...
  coordination: {
    title: 'בקשת שינוי לוח זמנים',
    subtitle: 'ההשפעה, התגובות, וההכרעה של הגורם המוסמך.',
    backToTask: 'חזרה למשימה',
    backToProject: 'חזרה ללוח הפרויקט',
    notFound: 'הבקשה אינה זמינה.',
    loading: 'טוען…',
    requestedBy: 'הבקשה הוגשה על ידי {name}',
    requestedByMe: 'זו הבקשה שלי',
    reason: 'הסיבה שנמסרה',
    initiating: 'המשימה שממנה יצאה הבקשה',
    window: 'חלון התגובה נסגר ב־{date}',
    windowHours: 'חלון תגובה: {n} שעות',
    noWindow: 'טרם הופעל, ולכן אין עדיין חלון תגובה.',
    changes: {
      title: 'מה התבקש',
      days: 'תוספת של {n} ימי עבודה',
      daysNegative: 'הקדמה של {n} ימי עבודה',
      altStart: 'התחלה חלופית ב־{date}',
      altDue: 'סיום חלופי ב־{date}',
    },
    status: {
      label: 'מצב',
      requested: 'ממתין להפעלה',
      open: 'פתוח לתגובות',
      expired: 'חלון התגובה נסגר',
      resolved: 'הוכרע',
      cancelled: 'בוטל',
    },
    statusNote: {
      requested: 'הבקשה נרשמה. אף לוח זמנים לא זז, ואיש עדיין לא נשאל.',
      open: 'כל בעל מקצוע מושפע משיב על העבודה שלו בלבד.',
      expired: 'חלון התגובה נסגר ולא קרה דבר אוטומטי. ההחלטה חזרה לגורם המוסמך.',
      resolved: 'ההכרעה בוצעה, והלוח עודכן לפיה.',
      cancelled: 'הבקשה בוטלה. התגובות שכבר ניתנו נשמרו בהיסטוריה.',
    },
    impact: {
      title: 'ההשפעה',
      lede: 'רק עבודה שנפגעת בפועל נכללת כאן. עבודה מקבילה שאינה חסומה אינה זזה.',
      empty: 'אין עבודה מושפעת מלבד הבקשה עצמה.',
      task: 'עבודה',
      stage: 'שלב',
      professional: 'בעל מקצוע',
      current: 'תאריך נוכחי',
      proposed: 'תאריך מוצע',
      shift: 'הזזה',
      shiftDays: '{n} ימי עבודה',
      reasonLabel: 'סיבת ההשפעה',
      unaffectedTitle: 'עבודה שממשיכה כרגיל',
      unaffectedLede: 'נבדקה, ואינה חסומה על ידי השינוי.',
      ceiling: 'תקרת האיחור של הפרויקט: {date}',
      ceilingExceeded: 'התאריך המוצע חורג מתקרת האיחור, ולכן אי אפשר להחיל אותו.',
      gateCount: 'מתוכן {n} מוחזקות על ידי שלב חוסם.',
    },
    reasonCode: {
      initiating: 'הבקשה עצמה',
      gate: 'שלב חוסם',
      sequence: 'רצף השלבים',
    },
    response: {
      ...
      accepted: 'אושר',
      declined: 'נדחה',
      countered: 'הוצעה חלופה',
      other_proposed: 'הוצע פתרון אחר',
      respondedAt: 'נענה ב־{date}',
      counterDates: 'החלופה שהוצעה: {start} עד {due}',
      declineReason: 'הסיבה שנמסרה',
      othersHidden: 'תגובות של בעלי מקצוע אחרים אינן מוצגות כאן.',
      excluded: 'הוצא מההשפעה',
    },
    declineReason: {
      health: 'בריאות',
      plans_not_ready: 'תוכניות שאינן מוכנות',
      equipment_failure: 'תקלה בציוד',
      permit_unavailable: 'היתר שאינו זמין',
      gc_stop: 'עצירה מטעם הקבלן הראשי',
      materials_not_arrived: 'חומרים שלא הגיעו',
      tools_not_arrived: 'כלים שלא הגיעו',
      none: 'לא נמסרה סיבה',
    },
    actions: {
      accept: 'אישור התאריך המוצע',
      decline: 'דחייה',
      counter: 'הצעת חלופה',
      other: 'הצעת פתרון אחר',
      otherLabel: 'מה הפתרון שמאפשר להמשיך בעבודה',
      counterStart: 'התחלה חלופית',
      counterDue: 'סיום חלופי',
      declineReasonLabel: 'סיבת הדחייה',
      noReason: 'ללא סיבה מהרשימה',
      send: 'שליחת התגובה',
      launch: 'הפעלת הבקשה',
      launchNote: 'ההפעלה שולחת את הבקשה לבעלי המקצוע המושפעים.',
      cancel: 'ביטול הבקשה',
      resolve: 'הכרעה והחלה',
      resolveNote: 'ההכרעה היא שמזיזה את הלוח. תגובה בפני עצמה אינה מזיזה דבר.',
      resolveNoteLabel: 'הערה להכרעה',
      exclude: 'הוצאה מההשפעה',
      include: 'החזרה להשפעה',
      failed: 'הפעולה נכשלה.',
      answered: 'התגובה נרשמה.',
    },
    resolution: {
      label: 'מה להחיל',
      none: 'לא להחיל',
      proposed: 'התאריך המוצע',
      counter: 'החלופה שהוצעה',
      other: 'הפתרון האחר שסוכם',
      replaced: 'רישום החלפת בעל מקצוע',
      replacedNote: 'רישום בלבד. העברת האחריות עצמה אינה חלק מהמסך הזה.',
      resolvedAt: 'הוכרע ב־{date}',
      note: 'הערת ההכרעה',
    },
    project: {
      title: 'תיאום ולוח זמנים',
      lede: 'בקשות פתוחות בפרויקט וההיסטוריה שלהן.',
      none: 'אין כרגע בקשה פתוחה בפרויקט.',
      open: 'בקשות פתוחות: {n}',
      awaitingMe: 'ממתינות לתגובה שלי: {n}',
      awaitingLabel: 'ממתין לי',
      affected: '{n} עבודות',
      pending: '{n} ממתינים',
      openRow: 'פתיחה',
    },
    audit: {
      ...
      lede: 'רישום של מה שקרה, אחרי שהוא כבר קרה.',
      empty: 'אין עדיין רישום היסטוריה שנוגע אליי.',
      partial: 'מוצג כאן רק מה שנוגע לעבודה שלי.',
      by: 'על ידי {name}',
    },
    alternatives: {
      title: 'חלופות לוח זמנים',
      lede: 'המערכת סורקת את ימי העבודה האפשריים לפי השלבים, תנאי המעבר בין השלבים והלוח הקיים, ומציגה רק סידורים שונים. הבחירה היא של הגורם המוסמך.',
      notRequested: 'לא נוצרו חלופות לבקשה הזו. אפשר ליצור אותן ולציין את האילוצים שצריך לכבד.',
      create: 'יצירת חלופות',
      recalculate: 'חישוב מחדש',
      earliestStart: 'מועד מינימלי לתחילת ביצוע',
      latestFinishForWork: 'סיום העבודה עצמה לא אחרי',
      latestFinishForChain: 'סיום כלל העבודות המושפעות לא אחרי',
      mustNotMove: 'עבודות שאסור להזיז — מזהים מופרדים בפסיק',
      note: 'הערת הקשר לגורם המוסמך',
      noteIsContext: 'ההערה מוצגת לגורם המוסמך בלבד ואינה משמשת את חישוב הלוח.',
      singleResult: 'רק סידור אחד עומד באילוצים הנוכחיים.',
      none: 'אף סידור אינו עומד באילוצים הנוכחיים.',
      window: '{start} עד {due}',
      chainEnds: 'סיום כלל העבודות: {date}',
      affected: 'עבודות מושפעות: {n}',
      professionals: 'בעלי מקצוע: {n}',
      onlyInitiating: 'השינוי אינו משפיע על עבודות אחרות',
      equivalent: 'עוד {n} מועדי התחלה מובילים לאותה תוצאה',
      select: 'בחירה בסידור הזה',
      selected: 'נבחר',
      truncated: 'הסריקה הוגבלה ל-{n} מועדי התחלה, ולכן ייתכנו סידורים נוספים רחוקים יותר.',
      whyTitle: 'מה הגביל את התוצאה',
    },
    explanation: {
      earliest_start: 'המועד המינימלי לתחילת ביצוע הוא {date}, ולכן מועדים מוקדמים יותר לא נבדקו.',
      latest_finish_work: '{n} סידורים נפסלו כי העבודה עצמה הסתיימה מאוחר מדי.',
      latest_finish_chain: '{n} סידורים נפסלו כי כלל העבודות המושפעות הסתיימו מאוחר מדי.',
      project_ceiling: '{n} סידורים נפסלו כי חרגו מתקרת האיחור של הפרויקט.',
      must_not_move: 'סידורים שהיו מזיזים עבודה שסומנה כקבועה נפסלו: {titles}.',
      stage_dependency: 'ב-{n} מהסידורים תלות בין שלבים או שלב חוסם חייבו הזזה של עבודה בהמשך.',
      working_calendar: '{n} ימים בטווח אינם ימי עבודה בלוח הקיים, ולכן לא שימשו כמועד התחלה.',
      frozen_work: '{n} עבודות שהושלמו או שאיבדו אחראי אינן יכולות לזוז.',
      pending_commitments: 'הבסיס לחישוב כולל התחייבויות מבקשות שעדיין פתוחות.',
      single_duration: 'הבקשה כוללת משך אחד בלבד, ולכן אין ממנה וריאציה נוספת.',
      equivalent_outcomes: '{n} מועדי התחלה הובילו לאותה תוצאה בדיוק, ולכן אוחדו.',
    },
    handoff: {
      title: 'העברת אחריות',
      lede: 'האחריות על העבודה עוברת מבעל מקצוע אחד לאחר. זו אינה האצלה חסויה — שם האחריות נשארת במקומה.',
      none: 'אין כרגע העברת אחריות פתוחה על העבודה הזו.',
      pending: 'הוצעה העברת אחריות מ־{from} אל {to}.',
      awaitingMembership: 'נשלחה הזמנה לפרויקט אל {to}. ההעברה ממתינה לתשובה.',
      awaitingNote: 'עד לתשובה האחריות נשארת במקומה, וההאצלה נשארת חסויה.',
      completedLabel: 'מה כבר בוצע עד הרגע הזה',
      toLabel: 'בעל המקצוע שמקבל את האחריות',
      pickPerson: 'בחירה מתוך חברי הפרויקט',
      authorityNote: 'אפשר להעביר אחריות רק אל חבר פעיל בפרויקט.',
      noCandidates: 'אין חבר אחר בפרויקט שאפשר להעביר אליו את האחריות.',
      needsPerson: 'צריך לבחור את מי שמקבל את האחריות.',
      initiate: 'פתיחת העברת אחריות',
      disclose: 'חשיפת המבצע בפועל והעברת האחריות אליו',
      discloseWho: 'המבצע בפועל: {name}',
      accept: 'אישור קבלת האחריות',
      decline: 'דחיית ההעברה',
      accepted: 'האחריות הועברה.',
      declined: 'ההעברה נדחתה.',
      needsCompletion: 'צריך לרשום מה כבר בוצע לפני ההעברה.',
      failed: 'הפעולה נכשלה.',
      discloseDelegate: 'העברת האחריות אל מי שמבצע בפועל חושפת אותו לפרויקט. זו בחירה של האחראי בלבד.',
    },
    mute: {
      title: 'התראות הפרויקט',
      lede: 'ההשתקה מפחיתה רעש התראות מהפרויקט הזה, עבורי בלבד.',
      notice: 'ההשתקה אינה משנה חברות בפרויקט, הרשאות, נראות משימות או גישה לתוכן.',
      muted: 'מושתק',
      unmuted: 'פעיל',
      mute: 'השתקת הפרויקט',
      unmute: 'ביטול ההשתקה',
      failed: 'לא ניתן לעדכן את ההשתקה כרגע.',
      pendingNotifications: 'מנגנון ההתראות עצמו עדיין לא נבנה. ההעדפה נשמרת ותיקרא על ידו כשייבנה.',
    },
    pending: {
      title: 'ממתין לי',
      none: 'אין כרגע פעולה שממתינה לי.',
      proposals: 'בקשות שממתינות לתגובה שלי: {n}',
      handoffs: 'העברות אחריות שממתינות להחלטה שלי: {n}',
      badge: 'ממתין לי: {n}',
    },
    stages: {
      title: 'שלבי הפרויקט והתלויות ביניהם',
      lede: 'התלות בבנייה היא בין שלבים שלמים, לא בין משימות בודדות. השלבים כאן הם מה שמנוע ההשפעה עובר עליו.',
      back: 'חזרה ללוח הפרויקט',
      open: 'ניהול שלבים ותלויות',
      readOnly: 'התצוגה בלבד. ניהול השלבים דורש הרשאת ניהול רצף.',
      none: 'עדיין לא הוגדרו שלבים בפרויקט.',
      nameLabel: 'שם השלב',
      addTitle: 'שלב חדש',
      add: 'הוספת שלב',
      gate: 'שלב חוסם',
      gateHint: 'שלב חוסם מחזיק את כל העבודה שאחריו עד שהשלב כולו הושלם.',
      notGate: 'שלב רגיל',
      orderLabel: 'סדר תצוגה',
      moveUp: 'העלאה בסדר התצוגה',
      moveDown: 'הורדה בסדר התצוגה',
      dependsOn: 'תלוי בשלבים',
      dependsOnNone: 'אינו תלוי בשלב אחר',
      addDependency: 'הוספת תלות',
      removeDependency: 'הסרת התלות',
      save: 'שמירה',
      rename: 'שינוי שם',
      cycle: 'התלות הזו יוצרת מעגל, ולכן לא נשמרה.',
      failed: 'הפעולה נכשלה.',
      orderNote: 'סדר התצוגה אינו התלות. התלות היא מה שמחזיק עבודה בפועל.',
    },
    auditAction: {
      'proposal.requested': 'הוגשה בקשה לשינוי תאריך',
      'proposal.launched': 'הבקשה הופעלה ונשלחה למושפעים',
      'proposal.item_excluded': 'עבודה הוצאה מההשפעה',
      'proposal.item_included': 'עבודה הוחזרה להשפעה',
      'proposal.response_recorded': 'נרשמה תגובה',
      'proposal.counter_submitted': 'הוצעה חלופה',
      'proposal.counter_accepted': 'החלופה אושרה',
      'proposal.counter_rejected': 'החלופה נדחתה',
      'proposal.cancelled': 'הבקשה בוטלה',
      'proposal.expired': 'חלון התגובה נסגר',
      'proposal.resolved': 'הבקשה הוכרעה',
      'schedule.applied': 'הלוח עודכן',
      'schedule.partial_release': 'שחרור חלקי של עבודה',
      'work.replacement_recorded': 'נרשמה החלפת בעל מקצוע',
      'stage.early_completion': 'שלב הושלם לפני הזמן',
      'proposal.other_solution_proposed': 'הוצע פתרון אחר',
      'proposal.other_solution_agreed': 'הפתרון האחר סוכם',
      'proposal.other_solution_rejected': 'הפתרון האחר נדחה',
      'proposal.alternative_selected': 'נבחרה חלופת לוח זמנים',
      'work.handoff_initiated': 'הוצעה העברת אחריות',
      'work.handoff_accepted': 'האחריות הועברה',
      'work.handoff_declined': 'העברת האחריות נדחתה',
    },
  },

  terms: {
    title: 'תנאי השימוש',
    version: 'גרסה {version} · עדכון אחרון: 31 באוגוסט 2026',
    close: 'סגירה',
    done: 'קריאתי את התנאים',
    sections: [
      {
        heading: 'השירות',
      ...
      {
        heading: 'דיוק המידע',
        body: 'האחריות לדיוק המידע המוזן לפלטפורמה היא של המשתמש שהזין אותו — פרטי חשבון, פרטי פרויקט, משימות ותאריכים כאחד.',
      },
      {
        heading: 'שימוש חוקי ומקצועי',
        body: 'השימוש בפלטפורמה נועד לפעילות מקצועית, ועליו להיות חוקי והוגן.',
      },
      {
        heading: 'שימוש אסור',
        body: 'אין לעשות שימוש לרעה בפלטפורמה. בכלל זה התחזות לאדם או לגוף אחר, שליחת ספאם, הטרדה, והעלאת תוכן פוגעני, בלתי חוקי או מפר זכויות.',
      },
      {
        heading: 'אחריות מקצועית',
        body: 'מידע על פרויקטים, משימות ולוחות זמנים המוזן לפלטפורמה אינו מחליף אחריות מקצועית, חוזית, הנדסית, משפטית, בטיחותית או רגולטורית. האחריות להחלטות מקצועיות ולהתחייבויות נותרת אצל המשתמש.',
      },
      {
        heading: 'הגבלת גישה',
        body: 'במקרה של שימוש לרעה ניתן להגביל את הגישה לפלטפורמה, בהתאם לכללי הפלטפורמה.',
      },
      {
        heading: 'פרטיות ונתוני חשבון',
        body: 'הפלטפורמה שומרת את נתוני החשבון ואת המידע המוזן אליה לצורך הפעלת השירות. מסמך מדיניות פרטיות נפרד ומלא טרם פורסם.',
      },
      {
        heading: 'שינויים בשירות',
        body: 'הפלטפורמה נמצאת בפיתוח, והשירות עשוי להשתנות ככל שהיא מתפתחת.',
      },
    ],
  },
